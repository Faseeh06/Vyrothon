    ...
    <section ref={sectionRef} id="hero" className="relative min-h-screen flex items-center pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={contentRef} className="flex-1 w-full">
        ...
        <p className="mt-12 max-w-md font-mono text-sm text-muted-foreground leading-relaxed">
          Stack independent ciphers in order: plaintext flows forward through every node; decrypt walks the same
        ...
        <div className="mt-16 flex flex-wrap items-center gap-6 md:gap-8">
          ...
          >
            <ScrambleTextOnHover text="Open Builder" as="span" duration={0.6} />
